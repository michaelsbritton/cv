...
const SkillInfo = () => {
    ...
    const FlashcardInfo = {
        ...
        Information: [["Proficient in JavaScript, HTML, and CSS to design front-end web applications. Extensively used libraries such as Axios for sending API requests, Redux for managing app-wide state, and Bootstrap for styling and componets","Developed and deployed three full-stack web applications using React for front-end in 2021", "Competent with Document Object Model (DOM), lifecycle, and hooks"],["Developed and deployed two full-stack web apps using Django in 2021, implementing a static database and a dynamic database, respectively", "Set up Rest APIs for use in two released apps"],["Spent over 5 years studying and working in Python. Practiced object oriented programming, Big-O optimization, mathematical profiency (mostly using Project Euler), and scripting for NAS management", "Familiar with NumPy for data analysis and mathematical functions. Used Pandas with large series to analyze and visualize data. Learned Django framework, specifically for backend use"],["Used Matlab extensively for statistical analysis of neurological fMRI data in Helen Wills Neuroscience Institute at UC Berkeley.","Used SPM (Statistical Parametric Mapping) package for multiple regression and other analyses.","Implemented neural network pattern classification analysis and published scientific paper results."],
                        ["Used MySQL extensively for storing and analyzing large sets of fMRI statistical data. Used also for static database in web application","Used PostgresSQL for dynamic database in web application back-end.","Used MariaDB for website development and hosting on personal NAS (WordPress)"],["Used HTML and PHP to implement cryptocurrency trading bot that interfaced with an online exchange (Poloniex) and executed buys and sells based on market conditions"],["Mainly use Git for project version control. Familiar with SourceTree, but have mainly used command-line interface to push to, pull from, and clone repositories","Using Bitbucket repositories for full stack applications and Github repositories for personal projects."],["Extensively worked with Photoshop to edit photos and pictures for posters, flashcards, presentations, and personal use", "Used Illustrator to create vectorized images for web app projects","Used After Effects to design animated images for use in web apps","Used Lightroom to edit personal photos from SLR camera"],
                        ["Proficient at using Microsoft Word to create documents, worksheets, flashcards, posters, forms, etc. for both professional and private use", "Also proficient at Microsoft Excel to model data, perform analyses, make graphs, budget finances, calculate competition scoring, etc.", "Extensive use with Microsoft PowerPoint for scientific slides and class presentations. Used to teach online lessons"],["Proficient using Windows, MacOS, and Linux. Have used all three for programming and development. Mostly familiar with Red Hat for professional use and Ubuntu for personal use.           "]],            
        Images: [[IconJS, IconCSS, IconRedux, IconAxios, IconBootstrap],[IconRest],[IconPandas, IconNumPy],[IconSPM],
                    [IconMySQL, IconPostgres, IconMongoDB, IconMariaDB],[IconPHP],[IconGit, IconBitBucket, IconGitHub, IconSourceTree],[IconPhotoshop, IconIllustrator, IconAfterEffects, IconLightroom],
                    [IconWord, IconExcel, IconPowerPoint],[IconWindows, IconMac, IconLinux]],
        ImageProperties: [[5, 70],[1, 63],[2,27],[1, 38],
                            [4, 70],[1, 35],[4, 65],[4, 65],
                            [3, 55],[3, 50]]
